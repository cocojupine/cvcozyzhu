...
const copy = {
  CN: {
    ...
    thesis: ["把 AI 能力", "做成可验证、", "可交付的产品。"],
    statement: "AI 产品经理，聚焦生成式 AI 产品化、质量评估与 0→1 验证，把模糊需求推进为可测试、可协作、可交付的系统。",
    facts: [["02", "AI 创业项目"], ["03", "EI / IEEE 论文"], ["20+", "奖项与认可"], ["05", "产品实践经历"]],
    scroll: "查看经历与项目",
    experienceLabel: "EXPERIENCE / IMPACT",
    experienceTitle: "从复杂业务，到 AI 产品交付",
    experienceNote: "五段实践，覆盖企业级生成式 AI、创业产品、医疗系统与智能硬件。",
  ...
  EN: {
    ...
    eyebrow: "AI PRODUCT / 0→1 / EVALUATION",
    thesis: ["Turning AI", "into testable,", "shippable products."],
    statement: "AI product manager focused on generative-AI productization, quality evaluation, and zero-to-one validation—turning ambiguous needs into systems teams can test and ship.",
    facts: [["02", "AI ventures"], ["03", "EI / IEEE papers"], ["20+", "awards & recognition"], ["05", "product experiences"]],
    scroll: "View experience and work",
    experienceLabel: "EXPERIENCE / IMPACT",
    experienceTitle: "From complex systems to AI delivery",
    experienceNote: "Five roles spanning enterprise generative AI, start-ups, healthcare systems, and intelligent hardware.",
    projectsLabel: "SELECTED WORK / PROOF",
